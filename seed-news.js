...
// Load .env.local from admin-website
...
async function seedNews() {
  try {
    ...
    const categoryMap = {
      ...
      'Local News': categories.find(c => c.slug === 'politics'), // closest match
      'Health': categories.find(c => c.slug === 'politics'), // closest match
      'Cinema': categories.find(c => c.slug === 'entertainment'),
      'Business': categories.find(c => c.slug === 'politics'), // closest match
      'Crime': categories.find(c => c.slug === 'crimes'),
      'Automotive': categories.find(c => c.slug === 'politics'), // closest match
      'Obituary': categories.find(c => c.slug === 'entertainment'), // closest match
      'Classified': categories.find(c => c.slug === 'politics'), // closest match
    }
