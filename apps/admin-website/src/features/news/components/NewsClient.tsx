    ...
    <div className="max-w-[1200px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-0.5">{count} articles total</p>
        </div>
        <Link
          href="/content/news/new"
          className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-900 text-white rounded-lg text-xs sm:text-sm font-medium hover:bg-gray-700 transition-all"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-4 sm:mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2 sm:py-2.5 text-sm text-gray-900 bg-white border border-gray-200 rounded-lg outline-none focus:border-gray-400 transition-colors"
          />
          {searchQuery && (
            <button
        ...
        <div className="flex gap-2 sm:gap-3">
          <div className="relative flex-1 sm:flex-initial">
            <select
              ...
              className="appearance-none w-full pl-3 pr-9 py-2 sm:py-2.5 text-sm text-gray-900 bg-white border border-gray-200 rounded-lg outline-none focus:border-gray-400 cursor-pointer transition-colors"
            >
        ...
        {loading && newsItems.length === 0 ? (
          ...
          <>
            {newsItems.map((item) => (
              ...
              >
                {/* Top row: thumbnail + info + desktop actions */}
                <div className="flex items-center gap-3 sm:gap-4 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5 truncate">
                      {item.categories?.name || 'Uncategorized'} · {new Date(item.created_at).toLocaleDateString('en-GB')}
                    </p>
                  </div>

                  {/* Desktop actions - inline flex, no absolute */}
                  <div className="hidden sm:flex items-center gap-1 flex-shrink-0">
                    ...
                    <Link
                      ...
                      className="w-9 h-9 flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-900 hover:bg-gray-50 transition-colors"
                      title="Edit"
                    >
                ...
                <div className="flex items-center gap-1 px-3 pb-3 sm:hidden">
                  <button
                    onClick={() => togglePublish(item)}
                    className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors ${
                      item.is_published
